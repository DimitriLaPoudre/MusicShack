...
type Plugin interface {
	...
	AlbumSongs(ctx context.Context, instances []Instance, id string, limit int, offset int) (AlbumSongs, error)
	ArtistInfo(ctx context.Context, instances []Instance, id string) (ArtistInfo, error)
	ArtistAlbums(ctx context.Context, instances []Instance, id string, limit int, offset int) (ArtistAlbums, error)
