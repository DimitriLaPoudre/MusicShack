...
type Plugin interface {
	...
	AlbumInfo(ctx context.Context, instances []Instance, id string) (Album, error)
	AlbumSongs(ctx context.Context, instances []Instance, id string, limit int, offset int) ([]Song, error)
	ArtistInfo(ctx context.Context, instances []Instance, id string) (Artist, error)
	ArtistAlbums(ctx context.Context, instances []Instance, id string, limit int, offset int) ([]Album, error)
	PlaylistInfo(ctx context.Context, instances []Instance, id string) (Playlist, error)
	PlaylistSongs(ctx context.Context, instances []Instance, id string, limit int, offset int) ([]Song, error)
